...
export function Login() {
    ...
    const [formData, setFormData] = React.useState<IFormData>({ email: "", password: "" });
    const [formError, setFormError] = React.useState<IFormError>({ email: { error: false, message: "" }, password: { error: false, message: "" } });
